...
<head>
    ...
    <title>Thêm lô hàng không cấp chứng thư</title>
    <link rel="stylesheet" href="add.css">
</head>
<body>
    <h1>THÊM LÔ HÀNG KHÔNG CẤP CHỨNG THƯ</h1>
    <a href="index.php">Trở về trang chủ</a> <br/> <br/>
    <table border="1" cellspacing="0" id="customers">
    <?php
        echo "<form action='save_add_kc.php' method='post' enctype='multipart/form-data'>";
        if(isset($_POST['add']))
        {
            $data = $_POST['add'];
            $vt = explode('_', $data);
