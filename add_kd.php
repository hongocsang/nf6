...
<head>
    ...
    <title>Thêm lô hàng không đạt</title>
    <link rel="stylesheet" href="add.css">
</head>
<body>
    <h1>THÊM LÔ HÀNG KHÔNG ĐẠT</h1>
    <a href="index.php">Trở về trang chủ</a> <br/> <br/>
    <table border="1" cellspacing="0" id="customers">
    <?php
        echo "<form action='save_add_kd.php' method='post' enctype='multipart/form-data'>";
        if(isset($_POST['add']))
        {
            $data = $_POST['add'];
            $vt = explode('_', $data);
        ...
        echo "<tr><td>Năm:</td> <td><input type='text' name='nam'></td></tr>";
        echo "<tr><td>Số lượng không thông báo:</td> <td><input type='number' name='ktb' maxlength='2'></td></tr>";
